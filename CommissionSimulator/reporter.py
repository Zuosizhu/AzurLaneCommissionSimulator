...
CONFIG_OUTPUT_KEYS = [
    ...
    'EVENT_PAUSE_INTERVAL', 'EVENT_PAUSE_DURATION', 'ELITE_COUNT', 'BATTLE_COUNT', 'BOSS_COUNT',
...
REQUIRED_CONFIG_KEYS = [
    'TIME', 'OIL_RESUME_RATE', 'OIL_GET_PER_WEEK', 'OIL_OTHER_PER_DAY',
    'EVENT_PAUSE_INTERVAL', 'EVENT_PAUSE_DURATION', 'ELITE_COUNT', 'BATTLE_COUNT', 'BATTLE_TIME', 'MAP_COST_OIL',
